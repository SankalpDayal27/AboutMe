...
public class createAppointment extends javax.swing.JPanel {
    ...
    doctor d1=new doctor("12","nishant","Borivali");
    doctor d2=new doctor("11","kris","Powai");
    doctor d3=new doctor("10","kunj","Kandivali");
    doctor d4=new doctor("9","henil","Bhynadar");
    doctor d5=new doctor("8","mangesh","Kharghar");
    doctor d6=new doctor("7","pratham","Andheri");
